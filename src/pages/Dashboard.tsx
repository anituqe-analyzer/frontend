                  ...
                  <div key={offer.id} className="flex items-center justify-between p-4 border rounded-lg">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">Dodano: {offer.date}</p>
                      </div>
                    </div>
                    <div>
                      ...
                      {offer.status === 'verified' && <Badge className="bg-green-500">Zweryfikowano</Badge>}
                    </div>
                  </div>
                ))}
              </div>
        ...
        <TabsContent value="expert-zone">
          <Card className="border-muted/60 shadow-sm">
            <CardHeader>
              ...
              <CardDescription>
                Przedmioty wymagające Twojej oceny jako eksperta w kategorii "Militaria".
              </CardDescription>
            </CardHeader>
            <CardContent>
                    ...
                    <div className="flex-1 space-y-3">
                      <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-2">
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground mt-1">
                            Zgłaszający: <span className="font-medium text-foreground">{task.user}</span> • Data:{' '}
                            {task.date}
                          </p>
                        </div>
                      ...
                      <div className="flex flex-wrap gap-3 pt-2">
                        <Button asChild size="sm" variant="secondary" className="shadow-sm">
                          <Link to={`/expert/task/${task.id}`}>Zobacz szczegóły</Link>
                        </Button>
